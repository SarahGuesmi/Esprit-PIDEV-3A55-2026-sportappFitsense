 ...
 */
final class Version20260212092701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercise CHANGE duree duree INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercise CHANGE duree duree INT NOT NULL');
    }
}
