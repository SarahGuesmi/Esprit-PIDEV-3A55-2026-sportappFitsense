 ...
 */
final class Version20260305000824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chat_message CHANGE created_by_id created_by_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE chat_message ADD CONSTRAINT FK_FAB3FC16CD53EDB6 FOREIGN KEY (receiver_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE chat_message ADD CONSTRAINT FK_FAB3FC16B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE chat_message ADD CONSTRAINT FK_FAB3FC16896DBBDE FOREIGN KEY (updated_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE daily_nutrition ADD CONSTRAINT FK_36C779EBA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE etat_mental ADD created_by_id INT NOT NULL, ADD updated_by_id INT DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE user_id user_id INT NOT NULL');
        $this->addSql('ALTER TABLE etat_mental ADD CONSTRAINT FK_5662EE37A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE etat_mental ADD CONSTRAINT FK_5662EE37B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE etat_mental ADD CONSTRAINT FK_5662EE37896DBBDE FOREIGN KEY (updated_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE feedback_response ADD created_by_id INT NOT NULL, ADD updated_by_id INT DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE coach_id coach_id INT NOT NULL');
        $this->addSql('ALTER TABLE feedback_response ADD CONSTRAINT FK_7135A089A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE feedback_response ADD CONSTRAINT FK_7135A0893C105691 FOREIGN KEY (coach_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE feedback_response ADD CONSTRAINT FK_7135A089B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE feedback_response ADD CONSTRAINT FK_7135A089896DBBDE FOREIGN KEY (updated_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE notification ADD created_by_id INT NOT NULL, ADD updated_by_id INT DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CAB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CA896DBBDE FOREIGN KEY (updated_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE passkey_credential ADD created_by_id INT NOT NULL, ADD updated_by_id INT DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE passkey_credential ADD CONSTRAINT FK_DFD64A45B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE passkey_credential ADD CONSTRAINT FK_DFD64A45896DBBDE FOREIGN KEY (updated_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE profile_physique ADD CONSTRAINT FK_66934956A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE questionnaire CHANGE user_id user_id INT NOT NULL');
        $this->addSql('ALTER TABLE questionnaire ADD CONSTRAINT FK_7A64DAFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE questionnaire ADD CONSTRAINT FK_7A64DAF3C105691 FOREIGN KEY (coach_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recette_consommee ADD CONSTRAINT FK_D8B6A0C5A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recette_nutritionnelle ADD created_by_id INT NOT NULL, ADD updated_by_id INT DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE recette_nutritionnelle ADD CONSTRAINT FK_E4AA46C33C105691 FOREIGN KEY (coach_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recette_nutritionnelle ADD CONSTRAINT FK_E4AA46C3B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recette_nutritionnelle ADD CONSTRAINT FK_E4AA46C3896DBBDE FOREIGN KEY (updated_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE recommendation ADD created_by_id INT NOT NULL, ADD updated_by_id INT DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE recommendation ADD CONSTRAINT FK_433224D23C105691 FOREIGN KEY (coach_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recommendation ADD CONSTRAINT FK_433224D2A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recommendation ADD CONSTRAINT FK_433224D2B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recommendation ADD CONSTRAINT FK_433224D2896DBBDE FOREIGN KEY (updated_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE user_exercise_progress ADD created_by_id INT NOT NULL, ADD updated_by_id INT DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE user_exercise_progress ADD CONSTRAINT FK_DC72E985B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_exercise_progress ADD CONSTRAINT FK_DC72E985896DBBDE FOREIGN KEY (updated_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE workout ADD CONSTRAINT FK_649FFB723C105691 FOREIGN KEY (coach_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chat_message CHANGE created_by_id created_by_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE feedback_response DROP created_by_id, DROP updated_by_id, DROP updated_at, CHANGE coach_id coach_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE questionnaire CHANGE user_id user_id INT DEFAULT NULL');
