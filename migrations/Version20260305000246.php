 ...
 */
final class Version20260305000246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD google_authenticator_secret VARCHAR(255) DEFAULT NULL, ADD photo VARCHAR(255) DEFAULT NULL, ADD username VARCHAR(255) DEFAULT NULL, ADD name_firstname VARCHAR(255) NOT NULL, ADD name_lastname VARCHAR(255) NOT NULL, ADD phone_number VARCHAR(255) DEFAULT NULL, DROP firstname, DROP lastname, CHANGE account_status account_status VARCHAR(50) NOT NULL, CHANGE date_creation date_creation DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE email email_email VARCHAR(180) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD firstname VARCHAR(255) NOT NULL, ADD lastname VARCHAR(255) NOT NULL, DROP google_authenticator_secret, DROP photo, DROP username, DROP name_firstname, DROP name_lastname, DROP phone_number, CHANGE account_status account_status VARCHAR(20) NOT NULL, CHANGE date_creation date_creation DATETIME NOT NULL, CHANGE email_email email VARCHAR(180) NOT NULL');
